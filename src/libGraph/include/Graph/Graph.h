...
*/
    ...
    public:
        ...
        */
        GraphNode *add_node(const NodeData &data) {
            ...
            add_node(gn);
            nodes_by_content.emplace(data, gn);
            return gn;
        }
        ...
        */
        void remove_edge(const NodeData& from_node, const NodeData& to_node) {
            auto n1 = nodes_by_content.at(from_node);
            auto n2 = nodes_by_content.at(to_node);
            remove_edge(n1, n2);
        }
        ...
        * @return a vector of the neghbours of a given node
        */
        std::vector<size_t> neighbour_indices(GraphNode *source_node) const {
            using namespace std;

            vector<GraphNode *> nodes = neighbours(source_node);
    ...
    private:
        std::map<NodeData, GraphNode *> nodes_by_content;
